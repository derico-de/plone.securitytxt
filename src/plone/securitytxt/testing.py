...
class PloneSecuritytxtLayer(PloneSandboxLayer):
    """Custom testing layer for plone.securitytxt."""
    ...
    def setUpPloneSite(self, portal):
        """Set up Plone site."""
        self.applyProfile(portal, "plone.securitytxt:default")


FIXTURE = PloneSecuritytxtLayer()

INTEGRATION_TESTING = IntegrationTesting(
    bases=(FIXTURE,),
    name="PloneSecuritytxtLayer:IntegrationTesting",
)

FUNCTIONAL_TESTING = FunctionalTesting(
    bases=(FIXTURE,),
    name="PloneSecuritytxtLayer:FunctionalTesting",
)

ACCEPTANCE_TESTING = FunctionalTesting(
    bases=(FIXTURE, WSGI_SERVER_FIXTURE),
    name="PloneSecuritytxtLayer:AcceptanceTesting",
)
